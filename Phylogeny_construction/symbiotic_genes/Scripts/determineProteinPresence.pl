...
# List of files
$strainFile = 'intermediaryFiles/genomeList.txt';
...
foreach $i (@strain) {
	...
	say("@strain[$count]\t@hitArray[0]\t@hitArray[1]\t@hitArray[2]\t@hitArray[3]\t@hitArray[4]\t@hitArray[5]\t@hitArray[6]\t@hitArray[7]\t@hitArray[8]");
}
